...
-- CRIAR AS TABELAS NOVAS QUE FALTAM (Unidade e Perfil)
...
-- -- Limpar dados que podem conflitar com as novas FKs
...
-- Remover tabela antiga de produtos
...
-- Atualizar venda_item para referenciar produtos_variacoes
...
-- Adicionar coluna de nome normalizado em categorias
